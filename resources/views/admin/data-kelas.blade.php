...
<body class="bg-gray-50 font-sans">
  ...
  <aside id="sidebar"
    ...
    <nav class="p-4 space-y-2">
      ...
      <a href="data-kelas.html" class="block py-2 px-3 rounded bg-mint text-gray-800 font-semibold">🏷️ Data Kelas</a>
  ...
  <div class="md:ml-64 min-h-screen flex flex-col">
    ...
    <header class="flex items-center justify-between bg-white border-b px-4 py-3 shadow-sm">
      <div class="flex items-center space-x-3">
        ...
        <h2 class="text-lg font-semibold text-gray-700">Data Kelas</h2>
      </div>
    ...
    <main class="flex-1 p-6">
      <div class="bg-white p-6 rounded-xl shadow-md">
        <div class="flex justify-between items-center mb-6">
          ...
          <a href="tambah-kelas.html"
            class="bg-mint-dark hover:bg-mint text-gray-800 px-4 py-2 rounded-lg font-medium shadow">
            ➕ Tambah Data Kelas
          </a>
        </div>
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-gray-700">2025/2026</td>
