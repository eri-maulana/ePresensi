...
<body class="bg-gray-50 font-sans">
  ...
  <aside id="sidebar"
    ...
    <nav class="p-4 space-y-2">
      ...
      <a href="data-mahasiswa.html" class="block py-2 px-3 rounded bg-mint text-gray-800 font-semibold">🎓 Data Mahasiswa</a>
