        ...
        <header class="bg-white shadow-sm px-6 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-lg font-semibold text-gray-700">Profil Admin</h1>
                </div>
                <div class="flex items-center gap-4">
                    <span id="current-time" class="text-sm text-gray-500">--:--:--</span>
                    <img src="https://ui-avatars.com/api/?name=Administrator&background=22c55e&color=fff" 
                         alt="Administrator" 
        ...
        <main class="p-6">
            <div class="max-w-4xl mx-auto">
                    ...
                    <div class="md:flex">
                        <div class="md:flex-shrink-0 p-6 flex justify-center items-center bg-mint-light">
                            <img class="h-48 w-48 rounded-full object-cover border-4 border-white shadow-lg" 
                                 src="https://ui-avatars.com/api/?name=Administrator&background=22c55e&color=fff&size=200" 
                                 alt="Administrator">
                        </div>
                        <div class="p-6 md:flex-1">
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <a href="edit-admin.html" class="inline-flex items-center px-4 py-2 bg-accent text-white rounded-lg hover:bg-accent/90 transition-colors">
                ...
                <div class="flex justify-center mt-6">
                    <a href="logout.html" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg font-medium shadow">Logout</a>
                </div>
            </div>
        </main>
    </div>
