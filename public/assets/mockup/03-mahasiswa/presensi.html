...
<body class="font-sans bg-[#F8FCFA] text-gray-800">
  ...
  <aside id="sidebar"
    ...
    <nav class="p-4 space-y-2">
      <a href="dashboard-mahasiswa.html" class="block py-2 px-3 rounded hover:bg-mint-light text-gray-700">🏠 Dashboard</a>
      <a href="presensi.html" class="block py-2 px-3 rounded bg-mint text-gray-800 font-semibold">📝 Presensi</a>
  ...
  <div class="md:ml-64 transition-all duration-300">
    <header class="flex justify-between items-center bg-white shadow-sm px-6 py-4">
      <div class="flex items-center gap-3">
        ...
        <h1 class="text-lg font-semibold text-gray-700">Presensi Hari Ini</h1>
      </div>
