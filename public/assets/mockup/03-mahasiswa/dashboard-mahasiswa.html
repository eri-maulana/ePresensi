...
<body class="font-sans bg-[#F8FCFA] text-gray-800">
  ...
  <aside id="sidebar"
    ...
    <nav class="p-4 space-y-2">
      <a href="dashboard-mahasiswa.html" class="block py-2 px-3 rounded bg-mint text-gray-800 font-semibold">🏠 Dashboard</a>
      <a href="presensi.html" class="block py-2 px-3 rounded hover:bg-mint-light text-gray-700">📝 Presensi</a>
      <a href="riwayat-presensi.html" class="block py-2 px-3 rounded hover:bg-mint-light text-gray-700">📅 Riwayat Presensi</a>
      <a href="profil-mahasiswa.html" class="block py-2 px-3 rounded hover:bg-mint-light text-gray-700">👤 Profil</a>
    </nav>
  </aside>
  ...
  <div class="md:ml-64 transition-all duration-300">
    <header class="flex justify-between items-center bg-white shadow-sm px-6 py-4">
      <div class="flex items-center gap-3">
        ...
        <h1 class="text-lg font-semibold text-gray-700">Dashboard Mahasiswa</h1>
      </div>
